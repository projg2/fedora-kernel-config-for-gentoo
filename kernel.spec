...
%global distro_build 0.rc6.20211223gitbc491fb12513.44
...
%define pkgrelease 0.rc6.20211223gitbc491fb12513.44

# This is needed to do merge window version magic
%define patchlevel 16

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 0.rc6.20211223gitbc491fb12513.44%{?buildid}%{?dist}
...
Source0: linux-5.16-rc6-48-gbc491fb12513.tar.xz
...
%setup -q -n kernel-5.16-rc6-48-gbc491fb12513 -c
mv linux-5.16-rc6-48-gbc491fb12513 linux-%{KVERREL}
