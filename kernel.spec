...
%define pkgrelease 0.rc7.20220519gitf993aed406ea.56
%define kversion 5
%define tarfile_release 5.18-rc7-48-gf993aed406ea
# This is needed to do merge window version magic
%define patchlevel 18
# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 0.rc7.20220519gitf993aed406ea.56%{?buildid}%{?dist}
...
#
%changelog
* Thu May 19 2022 Justin M. Forbes <jforbes@fedoraproject.org> [5.18.0-0.rc7.20220519gitf993aed406ea.56]
...
* Thu May 19 2022 Fedora Kernel Team <kernel-team@fedoraproject.org> [5.18.0-0.rc7.f993aed406ea.55]
- Add CONFIG_EFI_DXE_MEM_ATTRIBUTES (Justin M. Forbes)
- efi: x86: Set the NX-compatibility flag in the PE header (Peter Jones)
- efi: libstub: ensure allocated memory to be executable (Baskov Evgeniy)
- efi: libstub: declare DXE services table (Baskov Evgeniy)
